...
> Transition status: this document is archival-only and non-normative for v0.2. Canonical language behavior is defined in `docs/zax-spec.md`. Do not add new normative decisions here; update `docs/zax-spec.md` instead.
