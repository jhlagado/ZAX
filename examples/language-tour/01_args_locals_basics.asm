...
ld HL, $0000                   ; 0165: 21 00 00
push HL                        ; 0168: E5
push AF                        ; 0169: F5
push BC                        ; 016A: C5
push DE                        ; 016B: D5
push HL                        ; 016C: E5
ld HL, $0014                   ; 016D: 21 14 00
push HL                        ; 0170: E5
ld HL, $000A                   ; 0171: 21 0A 00
push HL                        ; 0174: E5
call add_words                 ; 0175: CD 00 00
inc SP                         ; 0178: 33
inc SP                         ; 0179: 33
inc SP                         ; 017A: 33
inc SP                         ; 017B: 33
push DE                        ; 017C: D5
ex DE, HL                      ; 017D: EB
ld (IX - $000A), E             ; 017E: DD 73 F6
ld (IX - $0009), D             ; 0181: DD 72 F7
ex DE, HL                      ; 0184: EB
pop DE                         ; 0185: D1
ld HL, $0007                   ; 0186: 21 07 00
push HL                        ; 0189: E5
call bump_byte                 ; 018A: CD 00 00
inc SP                         ; 018D: 33
inc SP                         ; 018E: 33
__zax_epilogue_2:
pop HL                         ; 018F: E1
