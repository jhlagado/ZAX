# Part 3 — Algorithms and Data Structures in ZAX

**New to Z80?** Start with [Part 1](../part1/README.md) and [Part 2](../part2/README.md) first.

This part is for readers who already understand the Z80 basics — either from Part 2 or from prior Z80 experience. Each chapter works through a real algorithm or data structure in ZAX, covering one area of the language as it comes up naturally.
