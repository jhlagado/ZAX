...
function containsCurrentLocation(expr: import('../frontend/ast.js').ImmExprNode): boolean {
  switch (expr.kind) {
...
function memSymbolicTarget(
  ctx: LoweringContext,
  op: import('../frontend/ast.js').AsmOperandNode | undefined,
...
function immExprFromOperand(
  op: import('../frontend/ast.js').AsmOperandNode | undefined,
): import('../frontend/ast.js').ImmExprNode | undefined {
...
function lowerClassicInstruction(ctx: LoweringContext, item: ClassicNode): void {
  ...
  const emitRelativeCurrentTarget = (
    opcode: number,
    targetExpr: import('../frontend/ast.js').ImmExprNode,
  ): boolean => {
