...
| Lowering helper seams                      | `lowering/pr532_asm_instruction_lowering_integration.test.ts`, `pr509_*.test.ts`, `pr510_*.test.ts`, `pr528_emission_core_helpers.test.ts`, `pr529_fixup_emission_helpers.test.ts`, `pr530_asm_utils_helpers.test.ts`, `pr531_value_materialization_helpers.test.ts`                            | Prefer these before adding another broad compile test.                                    |
