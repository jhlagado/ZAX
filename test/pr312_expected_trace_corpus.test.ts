...
async function expectLanguageTourTrace(
  exampleStem: string,
...
describe('PR312: expected-trace corpus expansion', () => {
  it('matches the curated arrays-and-indexing trace', async () => {
    await expectLanguageTourTrace(
      '10_arrays_and_indexing',
      'pr312_10_arrays_and_indexing.expected.asm',
    );
  });

  it('matches the curated records-and-fields trace', async () => {
    await expectLanguageTourTrace(
      '11_records_and_fields',
